// ============================================
// SCHEMAS — validación Zod para Scooters (MongoDB)
// ============================================
import { z } from 'zod';
...
export const objectIdSchema = z.object({
  id: z.string().regex(objectIdRegex, 'ID de MongoDB inválido'),
});
...
export const createScooterSchema = z.object({
  ...
  station: z
    .string()
    .regex(objectIdRegex, 'El ID de la estación debe ser un ObjectId válido')
    .optional()
    .nullable(),
});
